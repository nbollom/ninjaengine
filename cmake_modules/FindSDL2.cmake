...
IF(SDL2_LIBRARY_TEMP)
	...
	SET(SDL2_LIBRARIES ${SDL2_LIBRARY_TEMP} CACHE STRING "Where the SDL2 Libraries can be found")
	# Set the temp variable to INTERNAL so it is not seen in the CMake GUI
	SET(SDL2_LIBRARY_TEMP "${SDL2_LIBRARY_TEMP}" CACHE INTERNAL "")
ENDIF(SDL2_LIBRARY_TEMP)

foreach(SDL2_COMPONENT ${SDL2_FIND_COMPONENTS})
	string(TOLOWER ${SDL2_COMPONENT} SDL2_COMPONENT_LOWER)
	string(TOUPPER ${SDL2_COMPONENT} SDL2_COMPONENT_UPPER)
	find_library(SDL2_${SDL2_COMPONENT_UPPER}_LIBRARY
			NAMES SDL2_${SDL2_COMPONENT_LOWER}
			HINTS
			$ENV{SDL2DIR}
			PATH_SUFFIXES lib64 lib lib/x64 lib/x86
			PATHS ${SDL2_SEARCH_PATHS}
			)
	if (SDL2_${SDL2_COMPONENT_UPPER}_LIBRARY)
		set(SDL2_${SDL2_COMPONENT_UPPER}_FOUND TRUE)
		SET(SDL2_LIBRARIES ${SDL2_LIBRARIES} ${SDL2_${SDL2_COMPONENT_UPPER}_LIBRARY})
	else()
		set(SDL2_FOUND FALSE)
		message(WARNING "SDL2 component ${SDL2_COMPONENT} not found")
	endif ()
endforeach()
